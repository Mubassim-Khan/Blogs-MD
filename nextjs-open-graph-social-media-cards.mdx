...
If you don't provide Open Graph metadata in your blog, a post might look like this when you share it:
        ...
        <CustomImage src="https://raw.githubusercontent.com/Mubassim-Khan/Blogs-MD/master/images/tweet-without-open-graph.jpg" alt="Tweet without Open Graph metadata" width={400} height={269} />

But if you do provide Open Graph metadata, a shared post might look like this instead: 

        <CustomImage src="https://raw.githubusercontent.com/Mubassim-Khan/Blogs-MD/master/images/tweet-with-open-graph.jpg" alt="Tweet with Open Graph metadata" width={400} height={545} />
...
```ts
openGraph: {
    title: "Mubassim Ahmed Khan",
    description: "Hello, I'm Mubassim. 👋 I teach coding and web development skills.",
    url: 'https://www.mubassim-khan.netlify.app/',
    siteName: "Dave Gray's Blog",
    type: 'website',
    images: [
      {
        url: 'https://raw.githubusercontent.com/Mubassim-Khan/Blogs-MD/master/images/og-card.png',
        secureUrl: 'https://raw.githubusercontent.com/Mubassim-Khan/Blogs-MD/master/images/og-card.png',
        width: 1200,
        height: 630,
...
<meta property="og:image" content="https://raw.githubusercontent.com/Mubassim-Khan/Blogs-MD/master/images/og-card.png">
<meta property="og:image:secure_url" content="https://raw.githubusercontent.com/Mubassim-Khan/Blogs-MD/master/images/og-card.png">
...
<meta name="twitter:image" content="https://raw.githubusercontent.com/Mubassim-Khan/Blogs-MD/master/images/og-card.png">
...
openGraph: {
    ...
    images: [
        {
            url: `https://raw.githubusercontent.com/Mubassim-Khan/Blogs-MD/master/images/${meta.id}.png`,
            secureUrl: `https://raw.githubusercontent.com/Mubassim-Khan/Blogs-MD/master/images/${meta.id}.png`,
            width: 1200,
            height: 630,
...
<meta property="og:site_name" content="Dave Gray's Blog">
<meta property="og:image" content="https://raw.githubusercontent.com/Mubassim-Khan/Blogs-MD/master/images/nextjs-ordering-merging-metadata.png">
<meta property="og:image:secure_url" content="https://raw.githubusercontent.com/Mubassim-Khan/Blogs-MD/master/images/nextjs-ordering-merging-metadata.png">
<meta property="og:image:width" content="1200">
<meta property="og:image:height" content="630">
...
<meta name="twitter:image" content="https://raw.githubusercontent.com/Mubassim-Khan/Blogs-MD/master/images/nextjs-ordering-merging-metadata.png">
